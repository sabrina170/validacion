            ...
            <div class="modal-content">
                <form action="{{route('editaralumno',$alum->id)}}" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4">
                        <h2 class="col-span-12 sm:col-span-12"><strong>Editar Datos</strong></h2>
                       ...
                       <div class="col-span-12 sm:col-span-4 input-form">
                        ...
                        <div class="col-span-12 sm:col-span-4 input-form">
                         ...
                         <h2 class="col-span-12 sm:col-span-12"><strong>Credenciales del alumno</strong></h2>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    <h2 class="col-span-12 sm:col-span-12"><strong>Editar certificados</strong></h2>
                @foreach($certificados as $cer)  
                <a data-tw-toggle="modal"
                 data-tw-target="#editar-certi{{$cer->id}}" class="btn btn-primary mt-4">
